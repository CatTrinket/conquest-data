...
from common import types, decode_name
...
ranges = []
with open("/tmp/conquest/fsroot/data/WazaRange.dat", 'rb') as range_data:
    for _range in range(22):
        data, = unpack("<L", range_data.read(4))
        ranges.append(data)

moves = []
with open("/tmp/conquest/fsroot/data/Waza.dat", 'rb') as move_data:
